...
resource "aws_instance" "ec2_1" {
  ...
  user_data = <<-EOF
      ...
      sudo echo "<html><body><h1>Hello this is Tf-Module-1 at instance id `curl http://169.254.169.254/latest/meta-data/instance-id` </h1></body></html>" > /var/www/html/index.html
      EOF
}
